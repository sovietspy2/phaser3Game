...
function (_Phaser$Scene) {
  ...
  _createClass(LoadScene, [{
    ...
    value: function create() {
      console.log("LOAD SCENE CREATE FUNCTION START "); //this.scene.start(CST.SCENES.MENU)
...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    key: "create",
    value: function create() {
      console.log("yay menu"); //logo
      //this.add.image(this.game.renderer.width/2, this.game.renderer.height*0.20, "logo").setDepth(1);
      //this.add.text(400, 300, 'GAME OVER', { fontSize: '32px', fill: 'white' });

      this.add.image(400, 300, "title_bg").setDepth(0); //this.scene.start(CST.SCENES.MENU)

      var playButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.25, "playButton").setDepth(1);
